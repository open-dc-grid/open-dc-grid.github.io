...
The Open DC Grid is particularly well suited for distributing power in Solar Home Systems often used in the developing world when normal AC power is unavailable or unaffordable.
...
The Standard defines low level protocols to support billing mechanisms such as pay-as-you-go popular in the developing world but depends on reseller provided software to incorporate these low-level protocols
